...
#  params = {"userID": userId, "nextCallHistoryId": new_callHistoryID}
  ...
  if not from_client:
    ...
    if recordConference:
        ...
        resp = "<Response><Dial><Conference eventCallbackUrl=\"https://fluency-1.herokuapp.com/pushConfHistory?" + params + "\" statusCallbackEvent=\"end\" endConferenceOnExit=\"true\">" + to[11:] + "</Conference></Dial></Response>"
  else:
    # client -> PSTN
    if recordCall:
