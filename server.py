...
def call():
  ...
  if conf_name:
      resp = "<Response><Dial timeout=\"10\" record=\"true\" callerId=\"15204403178\"><Conference mute='false' startConferenceOnEnter='true' endConferenceOnExit='true'>" + conf_name + "</Conference></Dial></Response>"
      return resp
