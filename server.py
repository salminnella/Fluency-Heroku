...
def call():
  ...
  if not from_client:
    ...
    if recordCall:
        ...
        resp = "<Response><Dial callerId=\"" + caller_id + "\" action=\"https://fluency-1.herokuapp.com/pushCallHistory?" + params + "\" statusCallbackEvent=\"completed, end\" method=\"POST\"><Number>" + to + "</Number></Dial></Response>"
