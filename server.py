...
def call():
  ...
  if not from_client:
    ...
    if recordCall:
        ...
        resp = "<Response><Dial callerId=\"" + caller_id + "\" action=\"https://fluency-1.herokuapp.com/pushCallHistory?" + params + "\" method=\"POST\"><Number statusCallbackEvent=\"answered\">" + to + "</Number></Dial></Response>"
